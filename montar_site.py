...
relativos so fazem sentido no site.
...
def barra(atual):
    # com uma unica pagina, uma aba apontando para ela propria e ruido:
    # sobra so o atalho para os dados brutos
    itens = "".join(
...
<h1>Dados brutos</h1>
<p>As bases que alimentam o agregador, como saíram da coleta.
<a href="../">voltar</a></p>
<ul>{linhas}</ul>
</body></html>"""
